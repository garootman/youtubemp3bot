...
def test_extract_platform():
    ...
    dailymotion_url = "https://www.dailymotion.com/watch?v=12345"
    assert extract_platform(dailymotion_url) == "dailymotion"

    soundcloud_url = "https://www.soundcloud.com/watch?v=12345"
    assert extract_platform(soundcloud_url) == "soundcloud"

    invalid_url = "https://www.example.com/watch?v=12345"
    assert extract_platform(invalid_url) is None
